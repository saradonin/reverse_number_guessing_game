def guess(min=1, max=1000):
    ...
    print("""Let's play a game. Think of a number between 1 and 1000 and I'll guess it in 10 tries or fewer. 
Answer my questions by pressing keys on your keyboard: 
